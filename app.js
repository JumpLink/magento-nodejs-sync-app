...
app.get('/'+sync_shops_confs[0].url+'/product/list', routes.request.sync_shop.partnums.index_load);
app.get('/'+sync_shops_confs[0].url+'/product/info', routes.request.sync_shop.product.info_load);
